...
- Name:李浚銘(LI,TSUN MING)
- number:M11502214
- Research Direction: 5G and ORAN
- Briefly summarize your background and why you want to take this course:
  I research 5G networks and O-RAN architecture. I want to take this course to improve my foundational knowledge and advance my ongoing research.
...
- **LAB0: Basic Wireshark Operational and Capture**
    ...
    - Goal:
In this lab, You need to install the wirwshark application on your own laptop and know how to use it.
    - delivery: [李浚銘 Assignment Lab0](https://hackmd.io/@3CorByUGSuqDeJfs4QOBQg/HkesgBqKMx).
...
- **LAB2 : gNB TDD Traffic Analysis
    -  Assignment Information: [Lab2](https://hackmd.io/@Z4OmT2gcTXeLxBPXrn-2SQ/BJkbO0juze)
...
In this lab,you will compare three 5-second UDP iperf3 tests. You will learn how TDD slot allocation can affect downlink and uplink performance.
    - - delivery: 
    -  [ ] Peer review : [Vote the Top3](https://docs.google.com/forms/d/e/1FAIpQLScz-Kt_9ArkXOl8sG99549xqGK7W7vAqoY4lbbc3ph03zvFaw/viewform?usp=publish-editor) (DL: 23:59, Oct.7)
